if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[Admin_Restaurant_Update_v2]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[Admin_Restaurant_Update_v2]
GO
  


CREATE Procedure dbo.Admin_Restaurant_Update_v2
(  
 /*Restaurant*/  
    @RestaurantID int,  
...
GRANT EXECUTE ON [Admin_Restaurant_Update_v2] TO ExecuteOnlyRole
