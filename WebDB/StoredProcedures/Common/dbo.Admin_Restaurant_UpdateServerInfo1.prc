...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[Admin_Restaurant_UpdateServerInfo1]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[Admin_Restaurant_UpdateServerInfo1]
GO


create procedure [dbo].[Admin_Restaurant_UpdateServerInfo1]
(
	@RestaurantID int
...
grant execute on [Admin_Restaurant_UpdateServerInfo1] to ExecuteOnlyRole
